layui.config({
	...
	$('#add').on('click', function() {
		...
		addBoxIndex = layer.open({
			...
			zIndex: 19950924,
			maxmin: true,
			content:'../question/addQuestionIndex.do?pid='+0,
			end: function() {
				pagingInit();
				addBoxIndex = -1;
			}
	...
	function bind(){
		...
		$('.edit').on('click', function(){
			...
			addBoxIndex = layer.open({
				...
				zIndex: 19950924,
				maxmin: true,
				content:'../question/editQuestionIndex.do?id='+id+"&pid=0",
				end: function() {
					pagingInit();
					addBoxIndex = -1;
				}
		...
		$('.select').on('click',function(){
			...
			var data ={
						"title": name+"查看",
						"icon": "&#xe615",
						"href": "../question/findQuestionByPidIndex.do?pid="+id+"&questionType="+questionType,
						"spread": true
					};
